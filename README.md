...
> **Abstract:** *Knowledge graphs enable transparent reasoning in recommender systems by generating multi-hop paths to explain recommendations. While widely studied in entertainment and e-commerce, their generalizability to education remains underexplored due to dataset and evaluation inconsistencies. In this paper, we investigate three classes of path-based explainable reasoning for course recommendations, transforming three educational public datasets into knowledge graphs and training four state-of-the-art methods. Comparing them with non-explainable and collaborative filtering baselines, we assess utility, beyond-utility, and explainability metrics. Path-based generative methods excel in utility, catalog coverage, and explanation diversity, while traditional approaches still perform better in some beyond-utility metrics under sparsity. As sparsity decreases, path-based generative methods remain competitive.*
